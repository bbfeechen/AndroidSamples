...
public interface Shutdown extends Service {
	 ...
	 *   <TD colspan="4">shutdown web sever.<br>Caution!!<br>This API cannot be used only from the outside.</TD>
	 *   </TR>
	 *   <TR>
	 *   <TD BGCOLOR="#CCFFCC"><B>e.g. request(TBD)</B></TD>
	 *   <TD colspan="4">http://host:port/sony/shutdown<BR>{method:'actShutdown'}</TD>
	 *   </TR>
	 *   <TR>
	 ...
	 *
	 *
	 * @param  returnCb  Callback for actShutdown process
	 * @return  error code
	 *
	 */
	int actShutdown(ActShutdownCallback returnCb);
