...
public interface AwaitTakePicture extends Service {
	...
	/**
	 * Await Take picture and get picture url.
	 ...
	 *   </TR>
	 *   <TR>
	 *   <TD colspan="4">awaitTakePicture</TD>
	 *   </TR>
 	 *   <TR>
	 ...
	 *   <TD colspan="4">Await Take picture and get picture url.</TD>
	 *   </TR>
	 *   <TR>
	 *   <TD BGCOLOR="#CCFFCC"><B>e.g. request(TBD)</B></TD>
	 *   <TD colspan="4">http://host:port/sony/camera<BR>{method:'awaitTakePicture'}</TD>
	 *   </TR>
	 *   <TR>
	 ...
	 *
	 *
	 * @param  returnCb  Callback for awaitTakePicture process
	 * @return  error code
	 *
	 */
